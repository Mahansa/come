...
// Salin data yang sama ke sini. Dalam aplikasi nyata, ini akan diambil dari satu sumber (API)
const products = [
    {
        id: 1,
    ...
    // ... produk lainnya harus ada di sini juga
];
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Gunakan '==' karena ID dari URL adalah string, dan id di data adalah number
    const product = products.find(p => p.id == productId);

    if (product) {
        // 3. Jika produk ditemukan, isi halaman dengan datanya
        ...
        // 4. Atur fungsionalitas tombol kuantitas
...
// 5. Atur fungsionalitas tombol "Masukkan Keranjang"
